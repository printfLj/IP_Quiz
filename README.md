...
By splitting the code this way, your project is **Modular**. If you decide to change how you generate random IPs later, you only have to edit `IpUtils.php` without touching the rest of your app.# IP_Quiz
